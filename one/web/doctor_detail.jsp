                ...
                <div class="col m12 ">
                    <div class="card green lighten-5">
                        <div class="card-content" style="padding-bottom:0px">
                            <h3 style="text-align: center;font-family: 'Brush Script MT', cursive;">Welcome Doctor <b><%out.print(" "+session.getAttribute("name"));%></b></h3>
                                        ...
                                        <form class="col s12">
                                            <div class="row">
                                                <div class="input-field col s2" >
                                                    ...
                                                    <button type="button" class="btn"><a style="color: white" href="del_account.jsp">Del Account</a></button></button><br><br>
                                                ...
                                                <div class="input-field col s2 right-align" >
                                                    <button type="button" class="btn"><a style="color: white" href="patientForDoc.jsp">Patients</a></button><br><br>  
                                                </div>
                                            </div>
                                    </div>
                                </form>
