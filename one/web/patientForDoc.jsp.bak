    ...
    <body>
       ...
       %>
        ...
        <div class="row center-align">
            ...
            <form class="col s6 offset-m3 green lighten-5" action="remark" method="post" onsubmit="return validate5()">
            <div class="row">
                <br><br><br>
            </div>
                <h4>Patients</h4>      
            ...
            %>
            <div class="row">        
                <form name="hehe" class="col s6 offset-m3 green lighten-5" action="remark" method="post" onsubmit="return validate5()">
                <div class="row">
                    <br><br><br>
                    <div>
