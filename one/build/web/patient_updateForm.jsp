    ...
    <body>
        <%
            ...
            if(request.getSession(false)!=null){
                if(!"patient".equals(session.getAttribute("type"))){
                ...
                <div class="col m8 offset-m2">
                    <div class="card green lighten-5">
                        <div class="card-content" style="padding-bottom:0px">
                            ...
                            <div class="form">
                                <form name="signUp" action="update_qury" method="post" onsubmit="return validate3()">
                                      <div class="row">
                                        <form class="col s12">
                                          <div class="row">
                                            ...
                                            <div class="input-field col s4">
                                                <input id="i3" type="text" name="uName" class="validate" disabled="true" value="<% out.print(request.getAttribute("UName")); %>">
                                           ...
                                           <div class="input-field col s4">
                                            ...
                                            <div class="input-field col s6">
                                              ...
                                              <div class="input-field col s4" style="text-align: left">
                                                  <button  class="btn" ><a style="color: white" href="patient_detail.jsp">Back</a></button>
                                              </div>
